            ...
            $.each(response.data, function (keyCategory, valueCategory) {
                ...
                if (valueCategory.category_products.length) {
                    ...
                    $.each(valueCategory.category_products, function (key2, value2) {
                        ...
                        var campaignStart = value2.camp_start;
                        var campaignEnd = value2.camp_end;
                        ...
                        if (productType == 1) {
                            ...
                            '                                        <a href="javaScript:void(0);" data-spinner-id="' + randomBtnId + '" onclick="addToCart(this);" data-product-id="' + value2.id + '" data-product-name="' + value2.product_name + '" data-product-type="' + productType + '" data-product-price="' + priceForCart + '" data-product-qty="1" data-product-image="' + value2.product_image + '" class="btn btn-sm btn-fill-out btn-radius add-crt"><i class="icon-basket-loaded"></i>Add To Cart  <div id="addToCartSpinner' + randomBtnId + '" class="spinner-border spinner-border-sm d-none" role="status"><span class="sr-only"> Loading... </span></div></a>' +
                            '                                    </div>' +
                            '                                    <div class="pr_desc">' +

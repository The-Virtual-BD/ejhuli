...
function getFilteredProducts() {
    ...
    $.ajax({
        type: 'GET',
        url: BASE_URL + 'products/filtered/' + category_slug+'/'+sub_category_slug,
        data: {
        ...
        success: function (response) {
            ...
            if (response.status == 'success') {
                $.each(response.data,function (key,value) {
                    ...
                    var priceBox = '';
                    if (value.sale_price) {
                        priceBox += '<span class="price">$' + value.sale_price + '</span><br/><del>$' + value.regular_price + '</del>';
                        priceBox += ' <div class="on_sale"><span>' + ((( value.regular_price - value.sale_price )/ value.regular_price) * 100).toFixed(2) + '% Off</span></div>';
                    } else {
                    ...
                    filteredProducts += ` <div class="col-md-4 col-6">
                                <div class="item">
                                    <div class="product_wrap">
                                        ...
                                        <div class="product_info">
                                            ...
                                            <div class="rating_wrap mt-2" style="height: 40px;">
                                                <div class="rating">
                ...
                $("#filtered_products").html(filteredProducts);

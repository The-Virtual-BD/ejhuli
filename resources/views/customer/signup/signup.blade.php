                        ...
                        <div class="padding_eight_all bg-white">
                            ...
                            <form id="customerSignUpForm">
                                <div class="form-group" id="mobile_field">
                                    <input type="text" name="mobile_number" id="mobile_number" autocomplete="off" maxlength="11" class="form-control"  placeholder="Enter Your mobile">
                               ...
                               {{-- <div class="form-group" id="otpField" style="display: none">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="flag" id="flag" value="mobileverify">
